...
def supervisor_node(state):
    ...
    print("[DEBUG] supervisor_node output state:", state)
    return state


def job_search_node(state):
    print("[DEBUG] job_search_node input state:", state)
    """
    ...
    print("[DEBUG] job_search_node output state:", state)
    return state


def resume_analyzer_node(state):
    print("[DEBUG] resume_analyzer_node input state:", state)
    """
    ...
    print("[DEBUG] resume_analyzer_node output state:", state)
    return state


def cover_letter_generator_node(state):
    print("[DEBUG] cover_letter_generator_node input state:", state)
    """
    ...
    print("[DEBUG] cover_letter_generator_node output state:", state)
...
def web_research_node(state):
    print("[DEBUG] web_research_node input state:", state)
    """
    ...
    print("[DEBUG] web_research_node output state:", state)
    return state


def chatbot_node(state):
    print("[DEBUG] chatbot_node input state:", state)
    llm = ChatOpenAI(**state["config"])
    ...
    print("[DEBUG] chatbot_node output state:", state)
    return state
